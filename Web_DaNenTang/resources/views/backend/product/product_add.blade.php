...
<form id="myForm" method="post" action="{{ route('store.product') }}" enctype="multipart/form-data" >
 ...
 <input class="form-check-input" name="hot_deals" type="checkbox" value="1" id="flexCheckDefault">
    ...
    <div class="form-check">
			...
			<label class="form-check-label" for="flexCheckDefault">Ưu đãi</label>
		</div>
	</div>
...
<div class="col-md-6">	
    <div class="form-check">
			...
			<label class="form-check-label" for="flexCheckDefault">Đặc biệt</label>
		</div>
	</div>
    ...
    <div class="form-check">
			...
			<label class="form-check-label" for="flexCheckDefault">Siêu giảm giá</label>
		</div>
	</div>
